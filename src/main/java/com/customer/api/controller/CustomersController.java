...
import com.customer.api.domain.CustomerModel;
...
public class CustomersController {
	...
	public CustomerModel findCustomerOrdersByCustomerId(@PathVariable String customerId){
		Customers customer = customerService.findCustomerById(customerId);
		List<CustomerOrders> customerOrders = customerServiceClient.getCustomerProducts(customerId);
		CustomerModel customerModel = new CustomerModel();
		
		customerModel.setCustomers(customer);
		customerModel.setCustomerOrders(customerOrders);
